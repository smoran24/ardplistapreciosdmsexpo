sap.ui.define([
	...
	"sap/m/MessageBox",
	"ardplistapreciosdmsexpo/util/Utils",
	"ardplistapreciosdmsexpo/js/DialogSolicitudRevisionPrecio",
	...
	var aContexts;
	let that;
	return Controller.extend("ardplistapreciosdmsexpo.controller.Main", {
		...
		handleDescargarListaCompleta: function(){
			...
			$.ajax({
				type: 'POST',
				url: '/destinations/AR_DP_DEST_CPI/http/AR/DealerPortal/EnviarListaPrecios',
